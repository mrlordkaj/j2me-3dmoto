...
public class Message {
    ...
    public Message(byte type) {
        ...
        switch(type) {
            case TYPE_GEM:
                content = PlayResource.getInstance().getImageMessageGem();
                break;
                
            case TYPE_CHEST:
                content = PlayResource.getInstance().getImageMessageChest();
                break;
    ...
    public Message(String achievement) {
        type = TYPE_ACHIEVEMENT;
        content = ImageHelper.loadImage("/images/msgAchievement.png");
        achievementContent = StringHelper.split("|", achievement);
    }
}
